...
const std::string G4HepEmGSPWACorTableBuilder::gElemSymbols[] = {"H","He","Li","Be","B" ,
...
G4HepEmGSPWACorTableBuilder::G4HepEmGSPWACorTableBuilder(G4bool iselectron) : fIsElectron(iselectron) {
...
G4HepEmGSPWACorTableBuilder::~G4HepEmGSPWACorTableBuilder() {
  ClearDataPerElement();
  ClearDataPerMaterial();
}


void  G4HepEmGSPWACorTableBuilder::Initialise() {
...
void G4HepEmGSPWACorTableBuilder::InitDataPerElement() {
  // do it only once
...
void G4HepEmGSPWACorTableBuilder::InitDataPerMaterials() {
...
void G4HepEmGSPWACorTableBuilder::LoadDataElement(const G4Element *elem) {
  // allocate memory
...
void G4HepEmGSPWACorTableBuilder::InitDataMaterial(const G4Material *mat) {
...
void G4HepEmGSPWACorTableBuilder::ClearDataPerElement() {
...
void G4HepEmGSPWACorTableBuilder::ClearDataPerMaterial() {
